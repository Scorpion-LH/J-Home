          ...
          <div class="col-xs-12 col-sm-9 content">
            <div class="M-join panel panel-default">
              ...
              <div class="panel-body">
              	<form action="<?php echo U('Map/update_map');?>" method="post" class="form-horizontal">
              		<div class="form-group">
	              		<label for="name" class="control-label col-md-1">名称：</label>
	              		<div class="col-md-5">
	              			<input type="text" name="name" class="form-control" id="name" value="<?php echo ($list["name"]); ?>" required="required"/>
	              		</div>
              		</div><hr />
              		<div class="form-group">
	              		<label for="address" class="control-label col-md-1">地址：</label>
	              		<div class="col-md-7">
	              			<input type="text" name="address" class="form-control" id="address" value="<?php echo ($list["address"]); ?>" required="required"/>
	              		</div>
              		</div><hr />
              		<div class="form-group">
	              		<label for="telephone" class="control-label col-md-1" style="padding-left: 0;">联系电话：</label>
	              		<div class="col-md-3">
	              			<input type="text" name="telephone" class="form-control" id="telephone" value="<?php echo ($list["telephone"]); ?>" required="required"/>
	              		</div>
              		</div><hr />
              		<div class="form-group">
	              		<label for="time" class="control-label col-md-1" style="padding-left: 0;">营业时间：</label>
	              		<div class="col-md-3">
	              			<input type="text" name="time" class="form-control" id="time" value="<?php echo ($list["time"]); ?>" required="required"/>
	              		</div>
              		</div><hr />
