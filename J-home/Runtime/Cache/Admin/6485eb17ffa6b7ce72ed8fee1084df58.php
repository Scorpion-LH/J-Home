          ...
          <div class="M-news col-xs-12 col-sm-9 content">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
              	<a href="<?php echo U('News/newsadd');?>" class="btn btn-add btn-warning">添加文章</a>
              	<div class="col-xs-6 col-sm-5 col-md-3 pull-right">
              	<form action="<?php echo U('News/search');?>" method="get">
	              	<div class="input-group form-search">
		                <input type="date" name="search" class="form-control search-query" placeholder="搜索 类别 / 岗位">
              	...
              	<table class="table table-hover">
	                  ...
	                  <?php if(is_array($Mnews)): $i = 0; $__LIST__ = $Mnews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
	                  	<td class="news-thum">
	                  		<a href="<?php echo ($v["img"]); ?>" class="tooltip" title="<?php echo ($v["title"]); ?>">
	                  		<img src="<?php echo ($v["img"]); ?>"/>
	                  		</a>
	                  	</td>
	                  	<td><?php echo ($v["title"]); ?></td>
	                  	<td class="new-content"><?php echo ($v["describe"]); ?></td>
	                  	<td class="new-content"><?php echo (htmlspecialchars_decode($v["content"])); ?></td>
	                  	<td><?php echo ($v["time"]); ?></td>
	                  	<td><a href="<?php echo U('News/newsupdate',array('id'=>$v['id']));?>" class="btn btn-primary">修改</a>
	                  		<a href="<?php echo U('News/del_news',array('id'=>$v['id']));?>" class="del-hide" hidden="hidden" ><span>删除</span></a>
