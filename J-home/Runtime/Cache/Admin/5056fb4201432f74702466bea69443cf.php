          ...
          <div class="col-xs-12 col-sm-9 content">
            <div class="M-join panel panel-default">
              ...
              <div class="panel-body">
              	<form action="<?php echo U('News/add_news');?>" enctype="multipart/form-data" method="post" class="form-horizontal">
              		<div class="form-group">
	              		<label for="bt" class="control-label col-md-1">标题：</label>
	              		<div class="col-md-4">
              			<input type="text" id="bt" class="form-control" name="title" value="" required="required"/>
              			</div>
		              </div><hr />
		              <div class="form-group">
              		...
              		<div class="form-group">
	              		...
	              		<textarea id="describe" name="describe" rows="5" cols="50" class="form-control" required="required" style="width:400px;"></textarea><br /><hr />
	              	</div>
